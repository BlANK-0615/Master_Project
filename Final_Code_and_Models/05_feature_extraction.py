# This script uses the pre-prepared class'utils'in SCORCH 1.0 to calculate 
# three descriptors: BINANA, ECIF, Kier flexibility, and save the last generated feature.
...
def run_binana(pose_info,receptor_file):
    ...
    #5. ok add active site flexibility features to binana_features
    ...
    #6. ok add hydrophobic features to binana_features
    ...
    #8. ok add receptor hydrogen bond features to binana_features
    ...
    #9. ok add salt bridge features to binana_features
    ...
    #10 ok add aromatic stacking features to binana_features
    ...
    #12. ok add rotatable bond count to binana features
...
def process_all(receptor_folder, split_ligand_folder):
    ...
    all_features.to_csv('filename.csv', index=False)


# MAIN 
# define the receptor and ligand folders
receptor_folder = "path to receptor folder"
split_ligand_folder = "path to split ligand folder"
