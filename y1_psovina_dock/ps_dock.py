...
def dock_decoy(decoy_file, docker_command, receptor_folder, docked_folder, padding):
    ...
    try:
        ...
        print(filename)
        print(coordinates)
        # with open("pso_bs_01.txt", "a") as bind_site_file:
        ...
        # with open("Toco_01_progess_rate.txt", "a") as progress_file:
...
docker_command = "/home/s2331261/Master_Project/y1_psovina_dock/psovina-2.0/build/linux/release/psovina"
receptor_folder = "/home/s2331261/Master_Project/z1_3p_dataset/dock_source/all_receptors_ligands"
decoy_folder = "/home/s2331261/Master_Project/3_Docking/z2_test_dock_files/test_dock_03"
docked_folder = "pso_test_1"
padding = 12
