...
def convert_pdb_to_pdbqt(pdb_file):
    if pdb_file.endswith('.pdb'):
        ...
        # 构造输入文件和输出文件的路径
        input_file = os.path.join('/home/s2331261/Master_Project/BALLOON1.8.2/A2_correct_pdb_files', pdb_file)
        output_file = os.path.join('/home/s2331261/Master_Project/BALLOON1.8.2/A3_correct_pdbqt_files', f'{basename}_rdm.pdbqt')
        try:
            # 运行转换命令
            command = [
            ...
            with open('/home/s2331261/Master_Project/BALLOON1.8.2/qdbqt_error.txt', 'a') as f:
...
# 列出pdb文件
pdb_files = os.listdir('/home/s2331261/Master_Project/BALLOON1.8.2/A2_correct_pdb_files')
