...
def dock_decoy(decoy_file, docker_command, receptor_folder, docked_folder, padding):
    ...
    try:
        ...
        print(coordinates)
        with open("Toco_03_2_bind_site.txt", "a") as bind_site_file:
        ...
        with open("Toco_03_2_progess_rate.txt", "a") as progress_file:
        ...
        with open("Errors_03_02.txt", "a") as error_file:  # "a" 表示追加模式，新的内容会被写入到文件的末尾
...
decoy_folder = "/home/s2331261/Msater_Project/dock_job/3_Docking/decoy_qdbqt_03_2"
docked_folder = "Toco_docked_03_2"
padding = 12
